			...
			<div class="div-contentleft">
				...
				<div class="div-main">
					<div class="div-main-head2">
						<h3 class="div-title">
							FancyBBS <span class="div-JD-section-right"> 贴子总数 <span
								class="div-badge div-badge-node"> <%=topicTotalCount%> </span> </span>
						</h3>
					</div>
						...
						<div class="div-JD-list">
							<div class="div-JD-section-first">
								<a class="div-JD-section-left"
									href="article.jsp?sId=<%=session2.getId()%>"> <img
									class="div-JD-img" src="img/node/<%=session2.getId()%>.jpg"
									alt="<%=session2.getName()%>"> </a> <span
									class="div-JD-section-right div-JD-section-text-right">
									<p><%=session2.getTopicCount()%>个帖子/
									</p> </span>
								<div class="div-JD-section-body">
									<h4 class="div-JD-section-body-head">
										<a href="article.jsp?sId=<%=session2.getId()%>"><%=session2.getName()%></a>
									</h4>
									<p class="div-JD-section-body-bottom">
										<%=session2.getProfile()%></p>
								</div>
							</div>
						</div>
						<%
