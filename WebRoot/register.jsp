...
<body>
	...
	<div class="div-container">
		...
		<div class="div-loginandregister-adiv">
			<a id="a-header1" href="login.jsp">登录</a> <a id="a-header">注册</a>
		</div>
			...
			<div class="div-loginandregister-main">
				...
				<div class="div-logininandregister-inputmain">
					...
					<label id="loginlable1">用户名</label> <input name="account"
						id="register-account" type="text"
						placeholder="英文字母和数字组成的4-16位字符,以字母开头，允许纯英" />
				</div>

				<div class="div-logininandregister-inputmain">
					<!--密码-->
					<label id="loginlable1">密码</label> <input name="password"
						id="register-password" type="password"
						placeholder="6-20位英、数字、符号组合，区分大小写" />
				</div>

				<div class="div-logininandregister-inputmain">
					<!--确认密码-->
					<label id="loginlable1">确认密码</label> <input name="password1"
						id="register-password1" type="password" placeholder="请再次输入密码" />
				</div>

				<div class="div-logininandregister-inputmain">
					<!--验证码-->
					<label id="loginlable1">验证码</label> <input name="vcode"
						id="register-vcode" width="80px" type="text" placeholder="点击图片刷新" />

					<a href="register.jsp"><img id="rc" src="GetCaptcha"
